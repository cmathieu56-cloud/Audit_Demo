...
def traiter_un_fichier(nom_fichier, user_id):
    try:
        ...
        # Correction du chemin du modèle ici
        model = genai.GenerativeModel("models/gemini-3-flash-preview")
        res = model.generate_content(["Analyse cette facture et extrais le JSON complet", {"mime_type": "application/pdf", "data": file_data}])
...
# Fonction d'affichage SQL insérée proprement
...
if session:
    ...
    tab_config, tab_analyse, tab_import = st.tabs(["⚙️ CONFIG", "📊 ANALYSE", "📥 IMPORT"])
